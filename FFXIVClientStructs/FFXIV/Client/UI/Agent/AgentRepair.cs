...
public unsafe partial struct AgentRepair {
    ...
    [FieldOffset(0x58)] public int InventoryContainerIndex; // Used to lookup static array. Mapped index ids of repair gear dropdown. (7 = Equipped, 0 = Main/Off Hand, 1 = Head/Body/Hands, ...)
